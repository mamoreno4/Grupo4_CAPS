                ...
                for tamano in tamanos_T:
                    ...
                    while ((Grande == True) and (len(bodega.tanques_capacidad(tamano)) > 0)):
                        ...
                        if cantidad_6000[Nbodega][Ncepa] > tamano*0.95:
                            ...
                            resumen.ganancias+=1000*tamano*0.95*6000*despreciacion_6000[Nbodega][Ncepa]
                            print(6000)
                            print(despreciacion_6000[Nbodega][Ncepa])
                            print(tamano*0.95*6000*despreciacion_6000[Nbodega][Ncepa])
                        #si la cantidad es mayor que el 75% del tanque
                            ...
                            print(6000)
                            print(despreciacion_6000[Nbodega][Ncepa])
                            print(cantidad_6000[Nbodega][Ncepa]*6000*despreciacion_6000[Nbodega][Ncepa])

                            resumen.ganancias+=1000*cantidad_6000[Nbodega][Ncepa]*6000*despreciacion_6000[Nbodega][Ncepa]
                ...
                for tamano in tamanos_T:
                    ...
                    while ((Grande == True) and (len(bodega.tanques_capacidad(tamano)) > 0)):
                        ...
                        if cantidad_3000[Nbodega][Ncepa] > tamano*0.95:
                            ...
                            resumen.costo_dias+=tamano*0.95*25*Td.generado
                            print("3000")
                            print(despreciacion_3000[Nbodega][Ncepa])
                            print(tamano*0.95*3000*despreciacion_3000[Nbodega][Ncepa])

                            resumen.ganancias+=1000*tamano*0.95*3000*despreciacion_3000[Nbodega][Ncepa]
                            ...
                            print("3000")
                            print(despreciacion_3000[Nbodega][Ncepa])
                            print(cantidad_3000[Nbodega][Ncepa]*3000*despreciacion_3000[Nbodega][Ncepa])
                            resumen.ganancias+=1000*cantidad_3000[Nbodega][Ncepa]*3000*despreciacion_3000[Nbodega][Ncepa]
                ...
                for tamano in tamanos_T:
                    ...
                    while ((Grande == True) and (len(bodega.tanques_capacidad(tamano)) > 0)):
                        ...
                        if cantidad_1000[Nbodega][Ncepa] > tamano*0.95:
                            ...
                            resumen.costo_dias+=tamano*0.95*25*Td.generado
                            print("1000")
                            print(despreciacion_1000[Nbodega][Ncepa])
                            print(tamano*0.95*1000*despreciacion_1000[Nbodega][Ncepa])
                            resumen.ganancias+=1000*tamano*0.95*1000*despreciacion_1000[Nbodega][Ncepa]
                            ...
                            resumen.ganancias+=1000*cantidad_1000[Nbodega][Ncepa]*1000*despreciacion_1000[Nbodega][Ncepa]
                            print("1000")
                            print(despreciacion_1000[Nbodega][Ncepa])
                            print(cantidad_1000[Nbodega][Ncepa]*1000*despreciacion_1000[Nbodega][Ncepa])
